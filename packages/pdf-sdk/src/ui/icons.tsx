...
function paths(name: IconName, filled: boolean) {
  switch (name) {
    ...
    case 'hand':
      // Pan tool — a clean 4-way move glyph (reads better than a hand at 20px).
      return (
        <g {...OUTLINE}>
    ...
    case 'scroll-h':
      // Horizontal scrolling: a page frame with a left–right arrow through it
      // (distinct from the two-page `spread` glyph).
      return (
        <g {...OUTLINE}>
