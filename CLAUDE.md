...
- **Next:** Phase 1 desktop integration MVP (in `services/desktop`: `DocKind::Pdf`, open `.pdf`, native print-to-PDF); then Phase 2 annotation editor (Edit/Insert/Format menus + tools light up there).
