...
- **Next:** finish Phase 1 — outline/bookmarks panel, continuous/single scroll-mode toggle, desktop integration MVP (in `services/desktop`); then Phase 2 annotation editor.
